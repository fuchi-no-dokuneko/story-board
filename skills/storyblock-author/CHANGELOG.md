...
- Added a zero-dependency HTTPS client, strict JSON parser, local schema validator, typed UUIDv7 helpers, problem parser, generic endpoint caller, and high-level authoring workflows.
- Added complete bulk registration, persistence verification, incremental preview/commit, render, export, job, and artifact commands.
