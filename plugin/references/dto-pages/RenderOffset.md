...
Read the complete machine-readable contract: [JSON](../dtos/RenderOffset.schema.json).
完整機器可讀契約：[JSON](../dtos/RenderOffset.schema.json)。
完整机器可读契约：[JSON](../dtos/RenderOffset.schema.json)。
