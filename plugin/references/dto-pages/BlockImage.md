...
Read the complete machine-readable contract: [JSON](../dtos/BlockImage.schema.json).
完整機器可讀契約：[JSON](../dtos/BlockImage.schema.json)。
完整机器可读契约：[JSON](../dtos/BlockImage.schema.json)。
