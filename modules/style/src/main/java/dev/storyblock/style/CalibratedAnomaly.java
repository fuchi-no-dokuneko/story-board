...
final class CalibratedAnomaly {
  static StyleAnomalyDecision evaluate(StyleWindowScore operational, List<StyleWindowScore> nonOverlap, List<String> localized, StyleCalibrationConfidence confidence) {
