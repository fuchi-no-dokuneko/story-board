...
import static dev.storyblock.contracts.CanonicalPackageFields.REVISION_FIELDS;
...
final class CanonicalNovelPackageParseRevision {
    static RevisionEntry parseRevision(Map<String, Object> value) {
        ...
        Map<String, Object> document = CanonicalPackageObject.object(value.get("document"), "revision.document");
        try {
