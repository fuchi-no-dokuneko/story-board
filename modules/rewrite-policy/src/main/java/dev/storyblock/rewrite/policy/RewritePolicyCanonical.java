...
final class RewritePolicyCanonical {
    RewritePolicyCanonical() {
    }
    ...
    static int integer(Map<String, Object> value, String field, String path) {
        return RewritePolicyCanonicalIntegerFactory.integer(value, field, path);
    }

    static Instant instant(Map<String, Object> value, String field, String path) {
        return RewritePolicyCanonicalInstantFactory.instant(value, field, path);
    }

    static Map<String, Object> object(Object value, String path) {
        return RewritePolicyCanonicalObjectFactory.object(value, path);
    }
    ...
    static List<String> strings(Object value, String path) {
        return RewritePolicyCanonicalStringsFactory.strings(value, path);
    }
}
